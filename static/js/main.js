...
function updateConfigUI(status) {
  ...
  detailsHTML += `<li class="list-group-item ${
    status.beets_installed
      ? "list-group-item-success"
      : "list-group-item-danger"
  }">
                        <i class="fas fa-${
                          status.beets_installed ? "check" : "times"
                        }"></i> 
                        Beets Installation: ${
                          status.beets_installed ? "Installed" : "Not Installed"
                        }
                    </li>`;
  detailsHTML += `<li class="list-group-item ${
    status.config_exists ? "list-group-item-success" : "list-group-item-warning"
  }">
                        <i class="fas fa-${
                          status.config_exists ? "check" : "exclamation"
                        }"></i> 
                        Configuration File: ${
  ...
  detailsHTML += `<li class="list-group-item ${
    status.db_exists ? "list-group-item-success" : "list-group-item-warning"
  }">
                        <i class="fas fa-${
                          status.db_exists ? "check" : "exclamation"
                        }"></i> 
                        Database File: ${
                          status.db_exists ? "Found" : "Not Found"
                        } 
...
// Add a polyfill for crypto.randomUUID for browsers that don't support it
